...
describe('total likes', () => {
  ...
  test('of list with one blog, likes of that', () => {
    const result = listHelper.totalLikes(listWithOneBlog)
    assert.strictEqual(result, 5)
  }) 

  test('of list with several blogs is correct', () => {
...
describe('harder tests', () => {
  ...
  test('favorite blog', () => {
    const bestBlog = listHelper.favoriteBlog(listWithManyBlogs)
    assert.deepStrictEqual(bestBlog, listWithManyBlogs[2])
  })
